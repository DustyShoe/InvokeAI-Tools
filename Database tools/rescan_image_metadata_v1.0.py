...
"""Rescan outputs images and restore missing metadata in the database."""
...
def main() -> int:
    ...
    parser.add_argument("--recurse", action="store_true", help="Recurse into subfolders under outputs/images")
    ...
    for image_path in image_paths:
        ...
        try:
            ...
            if image_name in existing_metadata:
                ...
                stats["inserted"] += 1
                created_at = datetime.datetime.utcfromtimestamp(os.path.getmtime(image_path))
